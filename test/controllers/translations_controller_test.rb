...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { anwser: @translation.anwser, question: @translation.question, search_count: @translation.search_count } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { anwser: @translation.anwser, question: @translation.question, search_count: @translation.search_count } }
